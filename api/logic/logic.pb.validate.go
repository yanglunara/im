...
// Validate checks the field values on Proto with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *Proto) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on Proto with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in ProtoMultiError, or nil if none found.
func (m *Proto) ValidateAll() error {
	return m.validate(true)
}

func (m *Proto) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ProtoMultiError(errors)
	}

	return nil
}

// ProtoMultiError is an error wrapping multiple validation errors returned by
// Proto.ValidateAll() if the designated constraints aren't met.
type ProtoMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ProtoMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ProtoMultiError) AllErrors() []error { return m }

// ProtoValidationError is the validation error returned by Proto.Validate if
// the designated constraints aren't met.
type ProtoValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ProtoValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ProtoValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ProtoValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ProtoValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ProtoValidationError) ErrorName() string { return "ProtoValidationError" }

// Error satisfies the builtin error interface
func (e ProtoValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = ProtoValidationError{}
